...
Professor_Trash_Wheel = 
  ...
  janitor::clean_names()%>%
  drop_na()%>%
  paste(year(parse_date_time(year,)))
  mutate(
...
2.Second, clean the data in snp.csv using a similar process to the above. 
...
select(-day,-year_fix)
```
Big shout out to Stack overflow and the TA for help here!
...
ensuring that key variables have the same name; and 
...
5.Write a short paragraph about these datasets. 
